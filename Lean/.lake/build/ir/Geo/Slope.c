...
// Module: Geo.Slope
// Imports: Init Mathlib.Tactic Mathlib.Data.Matrix.Basic Mathlib.Algebra.Algebra.Basic Geo.Point
#include <lean/lean.h>
...
lean_object* initialize_Geo_Point(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Geo_Slope(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Geo_Point(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
