...
\begin{itemize}
  ...
  \item
    ...
    All three are depicted in~\Cref{fig:cup-cap-vars}.
...
if \lstinline|{x ∈ S ∣ σ a b x ≠ ccw}| and \lstinline|{x ∈ S ∣ σ a b x ≠ cw}|
are both empty shapes in \lstinline|P|,
then \lstinline|S| is an empty shape in \lstinline|P|.
