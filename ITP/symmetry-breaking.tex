\emph{Symmetry breaking} plays a key role in modern SAT-solving by substantially reducing the search space of assignments to a formula~\cite{biereHandbookSatisfiabilityVolume2009}.
...
This can be done while preserving $\sigma$-equivalence because sorting corresponds to a bijection between $L_2$ and $L_3$.
