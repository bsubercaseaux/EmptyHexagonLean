...
We begin in~\Cref{sec:geometry} by precisely stating the above theorem, and the geometric terms involved, in Lean. In a nutshell, the proof consists of building a CNF formula $\phi_n$ such that 
...
of triple orientations, and as we show in~\Cref{sec:triple-orientations}, whether $S$ contains a $k$-hole or not (i.e., \lstinline|HasEmptyKGon k S|) depends entirely on $\sigma_S$. 
