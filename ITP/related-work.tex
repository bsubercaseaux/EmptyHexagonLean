...
without broader changes), % WN: restored this parenthetical because it is useful for anyone who'd try to reproduce the run
...
instead passing our SAT proofs through the formally verified proof checker \texttt{cake\_lpr} \cite{tanVerifiedPropagationRedundancy2023}
