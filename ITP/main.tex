...
\begin{abstract}
  ...
  With a combination of geometric insights and automated reasoning techniques, Heule and Scheucher constructed CNF formulas $\Gamma_n$, with $O(n^4)$ clauses, such that if $\Gamma_n$ is unsatisfiable then every set of $n$ points in general position must contain an empty convex hexagon.
