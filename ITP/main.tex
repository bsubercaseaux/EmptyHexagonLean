...
\begin{abstract}
  ...
  An unsatisfiability proof for $n = 30$ was then found with a SAT solver using 16\,000 CPU hours of parallel computation, thus implying that the empty hexagon number $h(6)$ is equal to 30.
