...
To name a few examples, one case of the Erd\H{o}s discrepancy conjecture~\cite{konev2014sat}, Keller's conjecture~\cite{brakensiek2023resolution}, the packing chromatic number of the infinite grid~\cite{Subercaseaux_Heule_2023}, and the Pythagorean triples problem~\cite{Heule_2016} were all resolved using SAT solvers.
