...
\begin{itemize}
\item \textbf{(Reduction)} One shows that the mathematical theorem of interest is true if a concrete CNF formula $F$ is unsatisfiable.
...
However, as it is common in such results, their reduction argument is only sketched, relying heavily on intuition, and leaving several gaps to be filled.
...
In this paper we complete and formalize the reduction of Heule and Scheucher in the Lean theorem prover~\cite{demouraLeanTheoremProver2015}.
