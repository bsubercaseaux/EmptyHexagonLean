...
\tikzmarkin{a}(12.0,-0.3)(-0.5,0.5)
  ...
  \tikzmarkend{a}\left(\ov{\orvar_{a, b, c}} \land \ov{\orvar_{a, c, d}}\right) \rightarrow \ov{\orvar_{a, b, d}} \text{ for all } 2 \leq a < b < c < d \leq n \label{eq:signotopeClauses12}\\
%
...
\tikzmarkin{d}(12.0,-0.3)(-0.5,0.5)
  ...
  \tikzmarkend{d}\left(\orvar_{a, b, c} \land \orvar_{b, c, d}\right) \rightarrow \vvar_{a, c, d} \quad \text{ for all } 2 \leq a < b < c < d \leq n \label{eq:cupDef}\\
%
