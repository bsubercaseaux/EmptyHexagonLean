...
% meaning one could always avoid $7$-holes. 
...
\begin{gather}
  \left(\ov{\orvar_{a, b, c}} \lor \ov{\orvar_{a, c, d}} \lor \orvar_{a, b, d}\right) \land   \left(\orvar_{a, b, c} \lor \orvar_{a, c, d} \lor  \ov{\orvar_{a, b, d}}\right)
  \text{ for all } 1 \leq a < b < c < d \leq n\\
% \end{equation}
% \begin{equation}
\left(\ov{\orvar_{a, b, c}} \lor \ov{\orvar_{b, c, d}} \lor  \orvar_{a, c, d}\right) \land \left(\orvar_{a, b, c} \lor \orvar_{b, c, d} \lor  \ov{\orvar_{a, c, d}}\right)
\text{ for all } 1 \leq a < b < c < d \leq n\\
% \end{equation}
% \begin{equation}
...
%\end{equation}
  %\begin{equation}
    \orvar_{1, b, c} \quad \text{ for all } 2 \leq b < c \leq n\\
  %\end{equation}
  %\begin{equation}
 \left(\orvar_{\lceil \frac{n}{2} \rceil -1, \lceil \frac{n}{2} \rceil,\lceil \frac{n}{2} \rceil+1}, \ldots, \orvar_{2,3,4} \right) \preceq_{\text{lex}} \left(\orvar_{\lfloor \frac{n}{2}\rfloor +1,  \lfloor \frac{n}{2}\rfloor +2, \lfloor \frac{n}{2}\rfloor +3}, \ldots, \orvar_{n-2, n-1, n} \right)\\ 
  %\end{equation}
  %\begin{equation}
  \left(\orvar_{a,b,c} \lor \orvar_{b,c,d} \lor \uvar_{a, c, d} \right) \quad \text{ for all } 1 \leq a < b < c < d\\ 
  %\end{equation}
  %\begin{equation}
    \left(\ov{\uvar_{a,c,d}} \lor \orvar_{c,d,e} \lor \ov{\hvar_{a,c,e}}\lor \ufvar_{a, d, e} \right) \quad \text{ for all } 1 \leq a < b < c < d\\ 
    % \end{equation}
% \begin{equation}
...
% \end{equation}
% \begin{equation}
\orvar_{a, b, c} \land \orvar_{b, c, d} \rightarrow \vvar_{a, c, d} \quad \text{ for all } 1 \leq a < b < c < d \leq n\\
% \end{equation}
% \begin{equation}
 \ov{\uvar_{a,c,d}} \lor \ov{\vvar{a, c', d}} \lor \ov{\hvar_{a,c,c'}} \quad \text{ for all } 1 \leq a < c < c' < d \leq n\\
  % \end{equation}
  % \begin{equation}
    \ov{\uvar_{a,c,d}} \lor \ov{\vvar{a, c', d}} \lor \ov{\hvar_{a,c',c}} \quad \text{ for all } 1 \leq a < c' < c < d \leq n\\
    %  \end{equation}
    %  \begin{equation}
      \ov{\vvar_{a,c,d}} \lor \ov{\orvar_{c, d, e}} \lor \ov{\hvar_{a,c,e}} \quad \text{ for all } 1 \leq a < c < d < e \leq n
  \end{gather}
\end{spreadlines}
