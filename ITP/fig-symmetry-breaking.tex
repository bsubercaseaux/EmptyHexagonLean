...
\caption{Illustration of the proof of the symmetry breaking theorem. Note that the highlighted holes are preserved as $\sigma$-equivalence is preserved. For simplicity we have ommited the illustration of the \textsf{Lex order} property. }\label{fig:symmetry-breaking}
\end{figure}