...
\caption{There always exists a rotation (in this case by $45^\circ$) that makes all the $x$-coordinates different.}\label{fig:symmetry-breaking-2}
\end{subfigure}
\hfil
%
%\vspace{0.5cm}
...
\caption{Illustration of the proof of the symmetry breaking theorem. Note that the highlighted holes are preserved as $\sigma$-equivalence is preserved. For simplicity we have omitted the illustration of the \textsf{Lex order} property. }\label{fig:symmetry-breaking}
\end{figure}
