...
\centering
\begin{tikzpicture}
    \draw[help lines, color=gray!30, dashed] (-2,-2.3) grid (2,2.3);
    \draw[->,ultra thick] (-2.4,0)--(2.4,0) node[right]{$x$};
    \draw[->,ultra thick] (0,-2.4)--(0,2.4) node[above]{$y$};

    \draw[-, dashed, red] (-1.3, -2.4) -- (-1.3, 2.4);
    \draw[-, dashed, red] (-0.35, -2.4) -- (-0.35, 2.4);
    \draw[-, dashed, red] (0.6, -2.4) -- (0.6, 2.4);
...
\caption{After rotating by $45^\circ$  all $x$-coords.~are different.\\We show such an angle always exists.}\label{fig:symmetry-breaking-2}
\end{subfigure}
...
\begin{subfigure}{0.48\textwidth}
    \begin{tikzpicture}
        \draw[help lines, color=gray!30, dashed] (-1,-0.9) grid (2.9,2.9);
...
\begin{subfigure}{0.45\textwidth}
    \begin{tikzpicture}
        \draw[help lines, color=gray!30, dashed] (-1.2,-0.9) grid (2.9,2.9);
...
\caption{After applying the map $(x, y) \mapsto (y/x, 1/x)$.}\label{fig:symmetry-breaking-4}
\end{subfigure}
...
\begin{subfigure}{0.45\textwidth}
    \begin{tikzpicture}
        \draw[help lines, color=gray!30, dashed] (-1.5,-0.9) grid (2.9,4.2);
        \draw[->,ultra thick] (-1.4,0)--(3,0) node[right]{$x$};
        \draw[->,ultra thick] (0,-1)--(0,4.3) node[above]{$y$};
