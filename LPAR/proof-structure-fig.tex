\begin{figure}[ht]
    ...
    \begin{tikzpicture}
      ...
      \node[draw, rounded corners, align=center, fill=green!40!white] (tiffo) at (4.5,0) { \textbf{Reduction theorem}\\$\mathcal{T}$ holds if and only if $\mathcal{O}$ exists};
      ...
      \node[draw, rounded corners, align=center, fill=yellow!40!white] (encoding) at (9, -1.5) { \textbf{Encoding theorem}\\$\varphi_{\mathcal{O}}$ is satisfiable if and only if $\mathcal{O}$ exists};
      ...
      \draw[red, dashed, thick, rounded corners] (-1.75,1) -- (-1.75, -4) -- (12.25, -4) -- (12.25, 1) -- cycle;
    \end{tikzpicture}
